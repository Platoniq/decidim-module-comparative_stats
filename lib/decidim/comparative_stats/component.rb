...
Decidim.register_component(:comparative_stats) do |component|
  ...
  #   resource.model_class_name = "Decidim::ComparativeStats::SomeResource"
  #   resource.template = "decidim/comparative_stats/some_resources/linked_some_resources"
  # end
